...
(function () {
  ...
  const EN = {
    ...
    "nav.videos": `Videos`, "nav.eco": `The Ecosystem`, "nav.invest": `Invest`, "nav.decors": `Sets`, "nav.casting": `Cast`, "nav.demons": `Demons`,
    "demons.eyebrow": `The shadow pantheon`,
    "demons.title": `The <span class="text-grad-pink">Capitalism Demons</span>`,
    "demons.sub": `Behind SweetLife lurks a pantheon of demons. Each embodies an addiction. Their plan: get the Gloops hooked, sick and docile — the better to rule their world.`,
    "demon.sugar.v": `Sugar · the boss`, "demon.sugar.l": `Floods the city with SugarMaxX and runs the whole scheme. Make them sick, sell them more.`,
    "demon.alco.v": `Alcohol`, "demon.alco.l": `Drowns the Gloops in booze — a walking distillery on his back.`,
    "demon.gamb.v": `Gambling`, "demon.gamb.l": `Bet, lose, repeat. The addiction that glitters… and ruins.`,
    "demon.net.v": `Screens`, "demon.net.l": `"Just one more episode"… until you forget to live.`,
    "demon.nic.v": `Nicotine`, "demon.nic.l": `One puff, then a thousand. A cloud you never climb down from.`,
    "demon.tox.v": `Pharma`, "demon.tox.l": `Sells the cure for the sickness he created.`,
    "demon.twi.v": `Social media`, "demon.twi.l": `Likes, outrage, dopamine. Hooked on everyone else's gaze.`,
    "demon.only.v": `The Master`, "demon.only.l": `Behind every addiction, one true drug: money.`,
    ...
    "video.watch": `▶ Watch`,
    "loops.eyebrow": `The collection · endless Gloops`,
    "loops.sub": `Every Gloop is unique and collectible — generated from a single production asset.`,
    "loop.collection": `Collectible Gloops`,
